...
spa.avtr = (function () { 
  ...
  //read the css values from the provided $target avatar, 
  //and then invoke the model.chat.update_avatar method.
  ...
  //triggered when a user clicks or taps on the navigation area. 
  //This handler uses event delegation, as it only reacts if the element beneath the tap target is an avatar
  onTapNav = function ( event ){
   ...
   //This is triggered when the user starts a dragging motion in the navigation area.
   onHeldstartNav = function ( event ) {
    ...
    //triggered when the user is in the process of dragging an avatar. 
   //This is executed frequently, so calculations are kept to a minimum.
    ...
    // triggered when the user releases an avatar after a drag. 
    //The handler returns the dragged avatar back to its original color. 
    //It then invokes the updateAvatar method to read the avatar details and invoke the model.
    //chat.update_avatar ( <update_map> ) method
    ...
    //This is invoked when the Model publishes an spa-setchatee event. 
    ...
    onSetchatee = function ( event, arg_map ) {
     ...
     //This is invoked when the Model publishes an spa-listchange event. 
     ...
     onListchange = function ( event ){         
        ...
        // This is invoked when the Model publishes an spa-logout event. 
